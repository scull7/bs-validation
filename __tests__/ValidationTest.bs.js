...
describe("Validation", (function () {
        describe("Functor", (function () {
                ...
                return Jest.test("map should not modify a failure", (function () {
                              ...
                              var expected = /* Failure */Block.__(0, [/* int array */[1]]);
                              var actual = Curry._2(V[/* map */0], f, /* Failure */Block.__(0, [/* int array */[1]]));
                              return Jest.Expect[/* toEqual */12](expected, Jest.Expect[/* expect */0](actual));
                            }));
              }));
        describe("Applicative", (function () {
                ...
                Jest.test("Success/Failure#apply", (function () {
                        ...
                        var expected = /* Failure */Block.__(0, [/* int array */[7]]);
                        var actual = Curry._2(V[/* apply */1], /* Failure */Block.__(0, [/* int array */[7]]), Curry._2(V[/* apply */1], /* Success */Block.__(1, [3]), Curry._1(V[/* make */10], f)));
                        return Jest.Expect[/* toEqual */12](expected, Jest.Expect[/* expect */0](actual));
                      }));
                return Jest.test("Failure#apply", (function () {
                              ...
                              var expected = /* Failure */Block.__(0, [/* int array */[
                                    7,
                                    8
                                  ]]);
                              var actual = Curry._2(V[/* apply */1], /* Failure */Block.__(0, [/* int array */[8]]), Curry._2(V[/* apply */1], /* Failure */Block.__(0, [/* int array */[7]]), Curry._1(V[/* make */10], f)));
                              return Jest.Expect[/* toEqual */12](expected, Jest.Expect[/* expect */0](actual));
                            }));
              }));
                ...
                return Jest.test("mapFailure should map over a failure", (function () {
                              var f = function (param) {
                                if (param.length !== 1) {
                                  ...
                                  var x = param[0];
                                  return /* int array */[x + 10 | 0];
                                }
                              };
                              var expected = /* Failure */Block.__(0, [/* int array */[11]]);
                              var actual = Curry._2(V[/* mapFailure */9], f, /* Failure */Block.__(0, [/* int array */[1]]));
                              return Jest.Expect[/* toEqual */12](expected, Jest.Expect[/* expect */0](actual));
                            }));
              }));
        return /* () */0;
